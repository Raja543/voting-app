...
export async function PUT(request: NextRequest) {
  ...
  const { name, username, bio, abstractWallet, evmWallet, socialLinks, currentPassword, newPassword } = body;
  ...
  user.abstractWallet = abstractWallet ?? user.abstractWallet;
  user.evmWallet = evmWallet ?? user.evmWallet;
